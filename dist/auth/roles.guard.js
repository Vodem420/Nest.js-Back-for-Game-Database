    ...
    canActivate(context) {
        try {
            ...
            if (bearer !== 'Bearer' || !token) {
                throw new common_1.UnauthorizedException("user is not unathorised");
            }
            ...
            console.log(e);
            throw new common_1.HttpException("you haven't access for this page", common_1.HttpStatus.FORBIDDEN);
        }
    }
};
